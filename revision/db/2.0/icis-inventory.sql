...
-- Dumping data for table icis.inventory_items: ~5 rows (approximately)
REPLACE INTO `inventory_items` (`inventory_id`, `name`, `description`, `quantity`, `unit_price`, `reorder_level`, `supplier_id`) VALUES
	(1, 'Mouse', 'An input device use to navigate', 12, 269.00, 10, 2),
	(2, 'Wireless Keyboard', 'keyboard na walang wire', 5, 500.00, 10, 3),
	(3, 'Hologram Keyboard', 'hashdh', 2, 1200.00, 10, 3),
	(4, 'Wireless Mouse', '', 40, 199.00, 10, 2),
	(5, 'Wireless Keyboard K380', '', 1026, 0.01, 10, 1),
	(6, 'Gamu Gamu', '', 35, 10.00, 10, 4);
...
-- Dumping data for table icis.purchase_items: ~9 rows (approximately)
REPLACE INTO `purchase_items` (`po_item_id`, `po_id`, `inventory_id`, `quantity`, `unit_price`) VALUES
	(1, 1, 1, 30, 269.00),
	(2, 2, 1, 12, 100.00),
	(3, 3, 5, 12, 0.01),
	(4, 4, 1, 10, 269.00),
...
-- Dumping data for table icis.purchase_orders: ~11 rows (approximately)
REPLACE INTO `purchase_orders` (`po_id`, `supplier_id`, `order_date`, `total_amount`, `status`) VALUES
	...
	(16, 1, '2026-04-17', 10000000.00, 'Pending');
...
-- Dumping data for table icis.suppliers: ~3 rows (approximately)
REPLACE INTO `suppliers` (`supplier_id`, `name`, `contact_person`, `phone`, `email`, `address`) VALUES
...
-- Dumping data for table icis.users: ~0 rows (approximately)
...
-- Dumping data for table icis.vendor_payments: ~5 rows (approximately)
REPLACE INTO `vendor_payments` (`payment_id`, `supplier_id`, `po_id`, `pay_date`, `amount`) VALUES
